...
func Execute(args []string) {
	sourceName, destName, argsOffset, err := utils.ParseRenameArgs(args, config.DefaultProfileName)
	if err != nil {
	...
	utils.HandleGeneralError(profile.Copy(cfg, sourceName, destName, force))
}
